    ...
    <div class="main-content">
          ...
          <div class="overview-content">
            ...
            <div class="dimensions-list">
              <div
                ...
                v-for="item in teachingDimensions"
                :key="item.name"
              >
      ...
      <div class="detailed-section">
        ...
        <div class="detailed-grid">
          <div
            class="detailed-card glass-card"
            v-for="item in detailedEvaluation"
            :key="item.category"
          >
          ...
          <div class="analysis-content">
            ...
            <div class="analysis-dimensions">
              <div
                ...
                v-for="dimension in aiAnalysisDimensions"
                :key="dimension.name"
              >
...
const aiAnalysisDimensions = ref<AIAnalysisDimension[]>([
  {
    name: "教学目标分析",
    analysis:
      "教学目标设定清晰明确，符合课程标准要求，能够体现知识、能力、情感态度价值观三维目标的有机统一。目标表述具体可测，符合学生认知水平。",
    tags: [
  ...
  },
  {
    name: "教学内容分析",
    analysis:
      "教学内容选择恰当，重点突出，难点处理得当。内容组织逻辑清晰，层次分明，能够体现学科特点和知识结构。",
    tags: [
  ...
  },
  {
    name: "教学方法分析",
    analysis:
      "教学方法选择合理，能够灵活运用多种教学策略。注重启发式教学，能够调动学生积极性，体现学生主体地位。",
    tags: [
  ...
  },
  {
    name: "教学基本功分析",
    analysis:
      "教学语言规范流畅，表达清晰准确。板书设计合理，字迹工整。教态自然大方，具有较强的亲和力和感染力。",
    tags: [
  ...
  },
  {
    name: "教学效果分析",
    analysis:
      "教学效果良好，学生参与度高，课堂气氛活跃。能够有效达成教学目标，学生学习兴趣浓厚，知识掌握情况良好。",
    tags: [
  ...
  },
  {
    name: "课堂管理分析",
    analysis:
      "课堂管理有序，能够有效维持课堂纪律。师生关系和谐，能够及时处理课堂突发情况，营造良好的学习氛围。",
    tags: [
