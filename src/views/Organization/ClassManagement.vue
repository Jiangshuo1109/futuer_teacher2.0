    ...
    <div class="content-card">
      <div class="toolbar">
        ...
        <div class="toolbar-right">
          <el-select v-model="selectedMajor" placeholder="选择专业" style="width: 150px; margin-right: 8px" clearable>
            <el-option label="全部专业" value="" />
            <el-option label="计算机科学与技术" value="计算机科学与技术" />
            <el-option label="软件工程" value="软件工程" />
            <el-option label="学前教育" value="学前教育" />
          </el-select>
          <el-select v-model="selectedGrade" placeholder="选择年级" style="width: 120px; margin-right: 8px" clearable>
      ...
      <el-table :data="tableData" style="width: 100%" v-loading="loading">
        ...
        <el-table-column label="操作" width="200" fixed="right">
          <template #default="{ row }">
            ...
            <el-button type="info" size="small" text @click="handleViewStudents(row)">
              学生
            </el-button>
