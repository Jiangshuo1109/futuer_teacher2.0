<template>
  <div class="special-event-library">
    ...
    <div class="content-card">
      ...
      <el-table :data="tableData" style="width: 100%" v-loading="loading">
        ...
        <el-table-column prop="hasExample" label="示例图" width="80">
          <template #default="{ row }">
            <el-tag v-if="row.exampleImage" type="success" size="small"
              >有</el-tag
            >
    ...
    >
      ...
      >
        ...
        <el-form-item label="示例图片">
          ...
          >
            <img
              v-if="eventForm.exampleImage"
              :src="eventForm.exampleImage"
              class="example-image"
            />
          ...
          <div class="form-tip">
            上传能够说明该事件的示例图片，支持 JPG、PNG 格式，大小不超过 2MB
          </div>
        </el-form-item>
    ...
    <!-- 事件详情对话框 -->
    <el-dialog v-model="detailDialogVisible" title="特殊事件详情" width="800px">
      <div v-if="currentEvent" class="event-detail">
        <div class="detail-header">
          <div class="event-basic-info">
            ...
            <div class="event-meta">
              ...
              <el-tag
                :type="getLevelTagType(currentEvent.level)"
                size="large"
              ...
              <el-tag
                :type="currentEvent.status === 'active' ? 'success' : 'info'"
                size="large"
                style="margin-left: 8px"
              >
        ...
        <div class="detail-content">
          <el-descriptions :column="2" border>
            ...
            <el-descriptions-item label="发生频率"
              >{{ currentEvent.frequency }}%</el-descriptions-item
            >
            <el-descriptions-item label="使用次数">{{
              currentEvent.usageCount
            }}</el-descriptions-item>
        ...
        <div
          v-if="currentEvent.tags && currentEvent.tags.length"
...
const tableData = ref<SpecialEvent[]>([
  {
    ...
    level: "medium",
    description:
      "学生在课堂上突然出现身体不适症状，如头晕、恶心等，需要及时处理",
