          ...
          <el-card class="version-card">
            <div class="version-header">
              <div class="version-info">
                ...
                <el-tag :type="getVersionType(version.isLatest)">{{
                  version.isLatest ? "最新版本" : "历史版本"
                }}</el-tag>
              </div>
              <div class="version-actions">
                ...
                <el-button type="default" size="small" @click="viewVersionDetail(version)">
    ...
    >
      ...
      >
        <el-form-item label="版本名称" prop="versionName">
          <el-input
            v-model="uploadForm.versionName"
            placeholder="请输入版本名称"
          />
        </el-form-item>
...
const uploadRules: FormRules = {
  ...
  file: [{ required: true, message: "请选择客户端文件", trigger: "change" }],
};
