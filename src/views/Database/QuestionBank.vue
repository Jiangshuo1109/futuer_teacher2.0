    ...
    <div class="content-card">
      <div class="toolbar">
        ...
        <div class="toolbar-right">
          <el-select v-model="selectedType" placeholder="题目类型" style="width: 120px; margin-right: 8px" clearable>
          ...
          <el-select v-model="selectedDifficulty" placeholder="难度等级" style="width: 120px; margin-right: 8px" clearable>
